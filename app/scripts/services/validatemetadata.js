                        ...
                        angular.forEach(metadata, function (isolateMetadata) {
                            ...
                            angular.forEach(template.mandatory, function (key) {
                                ...
                                if (typeof (allowedValues) === typeof ([])) {
                                    // console.log(allowedValues, isolateMetadata[key].trim(), isolateMetadata[key], isolateMetadata[key].toLowerCase().trim());
                                    if (!_.contains(allowedValues, isolateMetadata[key].toLowerCase().trim()) && isolateMetadata[key].trim() !== '') {
                                        answer.errorMessages.push(
                                            '[Line ' + line.toString() + '] ' +
                                            key + ' ' + isolateMetadata[key] +
                                    ...
                                    } else if (isolateMetadata[key].trim() === '') {
                                        answer.errorMessages.push(
                                            '[Line ' + line.toString() + '] ' +
                                            key +' is empty!');
                                        console.log(
